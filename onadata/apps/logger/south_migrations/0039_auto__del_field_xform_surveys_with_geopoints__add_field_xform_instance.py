...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('odk_logger_xform', 'surveys_with_geopoints')

        # Adding field 'XForm.instances_with_geopoints'
        db.add_column('odk_logger_xform', 'instances_with_geopoints',
    ...
    def backwards(self, orm):
        ...
        db.add_column('odk_logger_xform', 'surveys_with_geopoints',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'XForm.instances_with_geopoints'
        db.delete_column('odk_logger_xform', 'instances_with_geopoints')
    ...
    models = {
        ...
        'odk_logger.instance': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'instances'", 'null': 'True', 'to': "orm['auth.User']"}),
