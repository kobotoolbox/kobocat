...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('odk_logger_instance', 'start_time')

        # Deleting field 'Instance.date'
        db.delete_column('odk_logger_instance', 'date')


    def backwards(self, orm):
        # Adding field 'Instance.start_time'
        db.add_column('odk_logger_instance', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Instance.date'
        db.add_column('odk_logger_instance', 'date',
