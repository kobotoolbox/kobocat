...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('api_project', 'metadata', self.gf('jsonfield.fields.JSONField')(default={'category': 'none'}))

    def backwards(self, orm):

        # Changing field 'Project.metadata'
        db.alter_column('api_project', 'metadata', self.gf('jsonfield.fields.JSONField')(null=True))
