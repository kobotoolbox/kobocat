...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('api_project_user_stars')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('api_project_user_stars'))
    ...
    models = {
        ...
        'api.project': {
            ...
            'user_stars': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'symmetrical': 'False'})
        },
        'api.projectxform': {
