...
ENKETO_OFFLINE_SURVEYS= ('/api/v2' in ENKETO_API_ROOT) and \
        (os.environ.get('ENKETO_OFFLINE_SURVEYS').lower() == 'true') # Offline surveys only possible in API v2.
ENKETO_API_ENDPOINT_OFFLINE_SURVEYS = '/survey/offline'
ENKETO_API_ENDPOINT_ONLINE_SURVEYS = '/survey'
ENKETO_API_ENDPOINT_SURVEYS= os.environ.get('ENKETO_API_ENDPOINT_SURVEYS') or os.environ.get('ENKETO_SURVEY_URL_PARTIAL') # TODO: Remove backward compatibility with "ENKETO_SURVEY_URL_PARTIAL".
if not ENKETO_API_ENDPOINT_SURVEYS:
...
ENKETO_API_ENDPOINT_INSTANCE= os.environ.get('ENKETO_API_ENDPOINT_INSTANCE') or os.environ.get('ENKETO_INSTANCE_URL_PARTIAL') or '/instance' # TODO: remove backward compatibility with "ENKETO_INSTANCE_URL_PARTIAL".
ENKETO_PREVIEW_URL_PARTIAL= os.environ.get('ENKETO_PREVIEW_URL_PARTIAL', '/webform/preview') # TODO: Use a "ENKETO_API_ENDPOINT_PREVIEW" of '/survey/preview' instead of this hardcoded URL.
ENKETO_API_ENDPOINT_INSTANCE_IFRAME= os.environ.get('ENKETO_API_ENDPOINT_INSTANCE_IFRAME') or os.environ.get('ENKETO_INSTANCE_IFRAME_URL_PARTIAL') or '/instance/iframe' # TODO: Remove backward compatibility with "ENKETO_INSTANCE_IFRAME_URL_PARTIAL".
